<div class="modal" id="addAirportPhrase">
    <i class="modal__close fa fa-times" aria-hidden="true"></i>
    <h1 class="modal__title mb-4">Dodaj zwrot</h1>
    <div class="form__message"></div>
   
    <form class="form"  @$errors action="{{ action('AirportController@store') }}" method="POST" @$enderrors id="addAirportPhrase" data-form="valid">
        {{ csrf_field() }}
